...
urlpatterns = [
    ...
    path('advanced/export/full.pdf', views.export_advanced_pdf, name='export_advanced_pdf'),
    path('advanced/export/full.docx', views.export_advanced_docx, name='export_advanced_docx'),
